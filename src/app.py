...
activities = {
    ...
    "Soccer Club": {
        "description": "Soccer training and intramural games",
    ...
    "Science Olympiad": {
        ...
        "max_participants": 14,
        "participants": ["nash@mergington.edu", "emily@mergington.edu"]
    },
    "Art Club": {
    ...
    "Music Ensemble": {
        "description": "Join the school orchestra, band, or choir",
        "schedule": "Tuesdays and Thursdays, 2:45 PM - 3:45 PM",
        "max_participants": 25,
